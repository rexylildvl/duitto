        ...
        <div class="col-md-6 d-flex justify-content-center align-items-center px-5">
            <div class="w-100" style="max-width: 400px;">
                <div class="mb-4 d-flex gap-4">
                    <a class="nav-link text-white fw-bold" href="{{ route('register') }}">Daftar</a>
                    <a class="nav-link active text-white fw-bold" href="{{ route('login') }}">Masuk</a>
                </div>
                <br>
                <h1 class="mb-4 fw-bold" style="font-family: 'Playfair Display', serif;">
                    Masuk ke Akun <br><span class="highlight">Duitto</span> mu!
                </h1>
                ...
                <form method="POST" action="{{ route('login') }}" class="form-box w-100">
                    ...
                    <div class="d-grid mt-4">
                        <button type="submit" class="btn btn-peach py-2">Masuk</button>
                    </div>
                </form>
            </div>
        </div>
